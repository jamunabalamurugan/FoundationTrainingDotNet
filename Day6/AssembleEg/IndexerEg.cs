...
namespace AssembleEg
{
    public class Student
    {
        ...
        public int IdNew { get => id; set => id = value; }

        //1.public int IdOld { get { return id; } set { id = value; } }
        //2.pubic int IdSecond {get;set;}//auto implemented
