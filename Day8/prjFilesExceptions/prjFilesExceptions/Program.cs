    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                s = new StreamReader(@"e:\at\MyFiles.txt");
                Console.WriteLine(s.ReadToEnd());
            ...
            {
                Console.WriteLine("The file could not be found "+obj.Message+ " "+obj.Source+" "+obj.TargetSite);
            }
            ...
            {
                Console.WriteLine("Sorry!Pls try later...."+obj.Message);
