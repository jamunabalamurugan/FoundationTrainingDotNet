...
{
    class InvalidNumberK : ApplicationException
    {
 
        public virtual string myMsg { get; set; }
        public InvalidNumberK() //Constructor
        {
        ...
        public InvalidNumberK(string str) : base(str) //Overloaded Constructor
        {
            myMsg = "The entered numbers must be greater than 10";
            //Message = "The entered numers is incorrect"; --Error as its a readonly property...Onlt get is allowed...set is not allowed
        }
    ...
    class MarksException:InvalidNumberK
    {
    ...
    class ExceptionExample
    {
        void Calculate()
        {
            ...
            try
            {
                ...
                if (num1 < 10 || num2 < 10)
                    throw new InvalidNumberK("Message is both numbers to be less than 10");
            ...
            catch (InvalidNumberK ie)
            {
                Console.WriteLine("myMsg :"+ie.myMsg);
                Console.WriteLine("Base class Message : "+ie.Message);
                Console.WriteLine("Base class StackTrace : "+ie.StackTrace);
